          ...
          >
            ...
            <Grid container spacing={1} alignItems="center">
                ...
                <Grid item xs={12} lg={6}>
                    ...
                    <LinearProgress variant="determinate" value={((currentEnergy/maxEnergy)*100).toFixed(0)} />
                    ...
                    <LinearProgress variant="determinate" color="success" sx={{'background-color':'red'}} value={calculateNrg.toFixed(0)} />
